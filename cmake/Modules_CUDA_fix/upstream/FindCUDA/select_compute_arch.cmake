...
function(CUDA_DETECT_INSTALLED_GPUS OUT_VARIABLE)
  if(NOT CUDA_GPU_DETECT_OUTPUT)
    ...
    if(run_result EQUAL 0)
      set(compute_capabilities_with_legacy_fallback "")
      foreach(compute_capability IN LISTS compute_capabilities)
        if(compute_capability STREQUAL "2.1")
          list(APPEND compute_capabilities_with_legacy_fallback "2.1(2.0)")
        else()
          list(APPEND compute_capabilities_with_legacy_fallback "${compute_capability}")
        endif()
      endforeach()
      set(compute_capabilities "${compute_capabilities_with_legacy_fallback}")
